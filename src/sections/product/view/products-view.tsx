...
export function ProductsView() {
  ...
  const fetchCategories = useCallback(async () => {
    try {
      const response = await axios.get('https://e6b5-154-71-159-172.ngrok-free.app/api/categorias/',{
        headers: {
  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.get(`https://e6b5-154-71-159-172.ngrok-free.app/api/produtos/empresa/${empresaId}/`,{
        headers: {
          "ngrok-skip-browser-warning": "true", // Evita bloqueios do ngrok
        },
      });
  ...
  const handleCreateProduct = async () => {
    ...
    try {
      const response = await axios.post(`https://e6b5-154-71-159-172.ngrok-free.app/api/produto/create/`, formData, {
        headers: {
