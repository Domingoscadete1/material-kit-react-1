...
export function UserTableRow({ row, selected, onSelectRow }: UserTableRowProps) {
  ...
  const baseUrl = "https://e6b5-154-71-159-172.ngrok-free.app/";
  ...
  const fetchPostos = useCallback(async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.get(`https://e6b5-154-71-159-172.ngrok-free.app/api/postos/empresa/${empresaId}/`,{
        headers: {
    ...
    <TableCell component="th" scope="row">
      <Box gap={2} display="flex" alignItems="center">
        <Avatar
          ...
          src={`https://e6b5-154-71-159-172.ngrok-free.app${postoAceite.posto?.imagem}`}
        />
